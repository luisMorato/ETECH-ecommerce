...
const AddressBox = ({ user, editFunction, deleteFunction, ...props }: addressBoxProps) => {
    return (
        <div className={twMerge("flex flex-col gap-5 bg-white rounded-xl p-5 flex-1 md:min-w-[300px]", props.className)}>
            ...
            <div className="flex flex-col justify-between h-full">
                ...
                {editFunction && deleteFunction && (
                    <div className="flex justify-between w-1/2 mx-auto text-mainBlue text-lg font-medium mt-3">
                        <button 
